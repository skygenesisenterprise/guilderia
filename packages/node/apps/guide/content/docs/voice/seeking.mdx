...
There is no built-in method for seeking audio resources in guilderia.js. However external libraries such as `prism-media` can be used to tackle this issue.
