...
```js
const { createAudioPlayer } = require('@guilderiajs/voice');
...
```js
const { createAudioPlayer, NoSubscriberBehavior } = require('@guilderiajs/voice');
...
```js
const { AudioPlayerStatus } = require('@guilderiajs/voice');
...
```js
const { createAudioResource } = require('@guilderiajs/voice');
