...
<GithubInfo owner="guilderiajs" repo="guilderia.js" />

If you're reading this, it probably means you want to learn how to make a bot with guilderia.js. Awesome! You've come to the right place.
...
Alright, making a bot is cool and all, but there are some prerequisites to it. To create a bot with guilderia.js, you should have a fairly decent grasp of JavaScript itself.
