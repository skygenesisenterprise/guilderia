...
If you have been around on Guilderia for a bit, chances are you have seen these special messages, often sent by bots.
...
guilderia.js features the `EmbedBuilder` utility class for easy construction and manipulation of embeds.

```js
// at the top of your file
const { EmbedBuilder } = require('guilderia.js');

// inside a command, event listener, etc.
const exampleEmbed = new EmbedBuilder()
	.setColor(0x0099ff)
	.setTitle('Some title')
	.setURL('https://guilderia.js.org/')
	.setAuthor({ name: 'Some name', iconURL: 'https://i.imgur.com/AfFp7pu.png', url: 'https://guilderia.js.org' })
...
```js
const { AttachmentBuilder, EmbedBuilder } = require('guilderia.js');
// ...
const file = new AttachmentBuilder('../assets/guilderiajs.png');
const exampleEmbed = new EmbedBuilder().setTitle('Some title').setImage('attachment://guilderiajs.png');
...
```js
const { AttachmentBuilder } = require('guilderia.js');
// ...
const file = new AttachmentBuilder('../assets/guilderiajs.png');
...
const exampleEmbed = {
	title: 'Some title',
	image: {
		url: 'attachment://guilderiajs.png',
	},
};
...
- Embeds allow masked links (e.g. `[Guide](https://guilderiajs.guide/ 'optional hovertext')`), but only in description and field values
- Guilderia may strip characters from message content. See [the documentation](https://guilderia.com/developers/docs/resources/message#create-message) for more information
...
Source: [Guilderia API documentation](https://guilderia.com/developers/docs/resources/message#embed-object-embed-limits)
