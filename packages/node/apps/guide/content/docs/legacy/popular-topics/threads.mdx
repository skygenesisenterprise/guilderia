...
```js
const { ChannelType, ThreadAutoArchiveDuration } = require('guilderia.js');
...
And that's it! Now you know all there is to know on working with threads using guilderia.js!
