...
While you might be familiar with [embeds](./embeds) in Guilderia, there are more ways to style and format your apps messages using **display components**, a comprehensive set of layout and content elements.
...
```js
const { TextDisplayBuilder, MessageFlags } = require('guilderia.js');
...
```js
const { SectionBuilder, ButtonStyle, MessageFlags } = require('guilderia.js');
...
```js
const { AttachmentBuilder, SectionBuilder, MessageFlags } = require('guilderia.js');
...
```js
const { AttachmentBuilder, MediaGalleryBuilder, MessageFlags } = require('guilderia.js');
...
```js
const { AttachmentBuilder, FileBuilder, MessageFlags } = require('guilderia.js');
...
```js
const { TextDisplayBuilder, SeparatorBuilder, SeparatorSpacingSize, MessageFlags } = require('guilderia.js');
...
```js
const { ContainerBuilder, UserSelectMenuBuilder, ButtonStyle, MessageFlags } = require('guilderia.js');
