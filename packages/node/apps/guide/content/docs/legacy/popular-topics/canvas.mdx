...
const { AttachmentBuilder, Client, Events, GatewayIntentBits } = require('guilderia.js');
...
We'll be using [this image](https://github.com/guilderiajs/guilderia.js/blob/main/apps/guide/content/docs/legacy/popular-topics/images/canvas.jpg) as the background in the welcome image, but you can use whatever you want. Be sure to download the file, name it `wallpaper.jpg`, and save it inside the same directory as your main bot file.
