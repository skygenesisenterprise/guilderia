...
function findEmoji(c, { nameOrId }) {
	...
	// If you wanted to delete the emoji with guilderia.js, this is where you would do it. Otherwise, don't include this code.
	emoji.delete();
	return emoji;
}
```
