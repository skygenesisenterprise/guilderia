...
```js
const { ButtonBuilder, ButtonStyle, SlashCommandBuilder } = require('guilderia.js');
...
```js
const { ActionRowBuilder, ButtonBuilder, ButtonStyle, SlashCommandBuilder } = require('guilderia.js');
...
const button = new ButtonBuilder()
	.setLabel('guilderia.js docs')
	.setURL('https://guilderia.js.org') // [!code word:setURL]
