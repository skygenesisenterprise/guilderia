...
<Callout>
	You need to have [Developer Mode](https://support.guilderia.com/hc/articles/206346498) enabled for this to show up!
</Callout>
...
Guilderia's API doesn't currently provide an easy way to delete guild-based commands that occur on multiple guilds from all places at once. Each will need a call of the above endpoint, while specifying the respective guild and command id.
