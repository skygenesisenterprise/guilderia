...
Sometimes, you would like to be able to customize guilderia.js's caching behavior in order to reduce memory usage.
To this end, guilderia.js provides you with two ways to do so:
...
```js
const { Client, Options } = require('guilderia.js');
