---
title: Installing Node.js and guilderia.js
---
...
To use guilderia.js, you'll need to install the latest LTS version of [Node.js](https://nodejs.org/).
...
To use guilderia.js, you'll need to install it via npm \(Node's package manager\). npm comes with every Node installation, so you don't have to worry about installing that. However, before you install anything, you should set up a new project folder.

Navigate to a suitable place on your machine and create a new folder named `guilderia-bot` (or whatever you want). Next you'll need to open your terminal.
...
Once you're done with that, you're ready to install guilderia.js!

## Installing guilderia.js

Now that you've installed Node.js and know how to open your console and run commands, you can finally install guilderia.js! Run the following command in your terminal:
