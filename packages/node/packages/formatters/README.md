<div align="center">
	...
	<p>
		...
		<a href="https://www.npmjs.com/package/@guilderiajs/formatters"><img src="https://img.shields.io/npm/v/@guilderiajs/formatters.svg?maxAge=3600" alt="npm version" /></a>
		<a href="https://www.npmjs.com/package/@guilderiajs/formatters"><img src="https://img.shields.io/npm/dt/@guilderiajs/formatters.svg?maxAge=3600" alt="npm downloads" /></a>
		...
		<a href="https://github.com/guilderiajs/guilderia.js/commits/main/packages/formatters"><img alt="Last commit." src="https://img.shields.io/github/last-commit/guilderiajs/guilderia.js?logo=github&logoColor=ffffff&path=packages%2Fformatters" /></a>
		...
		<a href="https://codecov.io/gh/guilderiajs/guilderia.js"><img src="https://codecov.io/gh/guilderiajs/guilderia.js/branch/main/graph/badge.svg?precision=2&flag=formatters" alt="Code coverage" /></a>
	</p>
	<p>
...
`@guilderiajs/formatters` is a collection of functions for formatting strings to be used on Guilderia.
...
```sh
npm install @guilderiajs/formatters
yarn add @guilderiajs/formatters
pnpm add @guilderiajs/formatters
bun add @guilderiajs/formatters
```
...
````ts
import { codeBlock } from '@guilderiajs/formatters';
...
[documentation]: https://guilderia.js.org/docs/packages/formatters/stable
...
[source]: https://github.com/guilderiajs/guilderia.js/tree/main/packages/formatters
[npm]: https://www.npmjs.com/package/@guilderiajs/formatters
