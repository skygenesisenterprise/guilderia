<div align="center">
	...
	<p>
		...
		<a href="https://www.npmjs.com/package/@guilderiajs/proxy"><img src="https://img.shields.io/npm/v/@guilderiajs/proxy.svg?maxAge=3600" alt="npm version" /></a>
		<a href="https://www.npmjs.com/package/@guilderiajs/proxy"><img src="https://img.shields.io/npm/dt/@guilderiajs/proxy.svg?maxAge=3600" alt="npm downloads" /></a>
		...
		<a href="https://github.com/guilderiajs/guilderia.js/commits/main/packages/proxy"><img alt="Last commit." src="https://img.shields.io/github/last-commit/guilderiajs/guilderia.js?logo=github&logoColor=ffffff&path=packages%2Fproxy" /></a>
		...
		<a href="https://codecov.io/gh/guilderiajs/guilderia.js"><img src="https://codecov.io/gh/guilderiajs/guilderia.js/branch/main/graph/badge.svg?precision=2&flag=proxy" alt="Code coverage" /></a>
	</p>
	<p>
...
`@guilderiajs/proxy` is a powerful wrapper around `@guilderiajs/rest` for running an HTTP proxy in front of Guilderia's API.
...
```sh
npm install @guilderiajs/proxy
yarn add @guilderiajs/proxy
pnpm add @guilderiajs/proxy
bun add @guilderiajs/proxy
```
...
[documentation]: https://guilderia.js.org/docs/packages/proxy/stable
...
[source]: https://github.com/guilderiajs/guilderia.js/tree/main/packages/proxy
[npm]: https://www.npmjs.com/package/@guilderiajs/proxy
