<div align="center">
	...
	<p>
		...
		<a href="https://github.com/guilderiajs/guilderia.js/commits/main/packages/util"><img alt="Last commit." src="https://img.shields.io/github/last-commit/guilderiajs/guilderia.js?logo=github&logoColor=ffffff&path=packages%2Futil" /></a>
...
`@guilderiajs/util` is a collection of utility functions for use with guilderia.js.
...
```sh
npm install @guilderiajs/util
yarn add @guilderiajs/util
pnpm add @guilderiajs/util
bun add @guilderiajs/util
```
...
[documentation]: https://guilderia.js.org/docs/packages/util/stable
...
[source]: https://github.com/guilderiajs/guilderia.js/tree/main/packages/util
[npm]: https://www.npmjs.com/package/@guilderiajs/util
