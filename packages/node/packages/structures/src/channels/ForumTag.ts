import type { APIGuildForumTag } from 'guilderia-api-types/v10';
...
export class ForumTag<Omitted extends keyof APIGuildForumTag | '' = ''> extends Structure<APIGuildForumTag, Omitted> {
	...
	/**
	 * Whether this tag can only be added to or removed from threads by a member with the {@link guilderia-api-types/v10#(PermissionFlagsBits:variable) | ManageThreads} permission.
	 */
