...
import { Routes, type RESTGetAPISoundboardDefaultSoundsResult } from 'guilderia-api-types/v10';
...
export class SoundboardSoundsAPI {
	 ...
	 *
	 * @see {@link https://guilderia.com/developers/docs/resources/soundboard#list-default-soundboard-sounds}
