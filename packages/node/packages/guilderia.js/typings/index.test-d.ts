...
} from '@guilderiajs/builders';
import type { ReadonlyCollection } from '@guilderiajs/collection';
import type {
  APIButtonComponent,
...
expectType<Promise<Invite>>(client.fetchInvite('https://guilderia.gg/djs'));
expectType<Promise<Invite<true>>>(client.fetchInvite('https://guilderia.gg/djs', { withCounts: true }));
expectNotType<Promise<Invite<true>>>(client.fetchInvite('https://guilderia.gg/djs', { withCounts: false }));
...
client.on('messageCreate', async message => {
  ...
  // https://github.com/guilderiajs/guilderia.js/issues/8545
  {
  ...
  const rawMedia: UnfurledMediaItemData = { url: 'https://guilderia.js.org' };
