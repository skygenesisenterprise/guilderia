...
import { Collection, ReadonlyCollection } from '@guilderiajs/collection';
import { BaseImageURLOptions, ImageURLOptions, RawFile, REST, RESTOptions, EmojiURLOptions } from '@guilderiajs/rest';
import { Awaitable, FileBodyEncodable, JSONEncodable, RawFileEncodable } from '@guilderiajs/util';
import { WebSocketManager, WebSocketManagerOptions } from '@guilderiajs/ws';
...
export class ClientVoiceManager {
  ...
  public adapters: Map<Snowflake, InternalGuilderiaGatewayAdapterLibraryMethods>;
}
...
export { Collection, type ReadonlyCollection } from '@guilderiajs/collection';
...
export class Guild extends AnonymousGuild {
  ...
  public get voiceAdapterCreator(): InternalGuilderiaGatewayAdapterCreator;
...
export {
  GuilderiaSnowflake as SnowflakeUtil,
...
export function guilderiaSort<Key, Value extends { id: Snowflake; rawPosition: number }>(
...
export enum GuilderiajsErrorCodes {
...
export class GuilderiajsError extends Error {
  private constructor(code: GuilderiajsErrorCodes, ...args: unknown[]);
  public readonly code: GuilderiajsErrorCodes;
  public get name(): `Error [${GuilderiajsErrorCodes}]`;
}

export class GuilderiajsTypeError extends TypeError {
  private constructor(code: GuilderiajsErrorCodes, ...args: unknown[]);
  public readonly code: GuilderiajsErrorCodes;
  public get name(): `TypeError [${GuilderiajsErrorCodes}]`;
}

export class GuilderiajsRangeError extends RangeError {
  private constructor(code: GuilderiajsErrorCodes, ...args: unknown[]);
  public readonly code: GuilderiajsErrorCodes;
  public get name(): `RangeError [${GuilderiajsErrorCodes}]`;
}
...
export type IntegrationType = 'guilderia' | 'guild_subscription' | 'twitch' | 'youtube';
...
/**
 * @remarks
 * Use `GuilderiaGatewayAdapterLibraryMethods` from `@guilderiajs/voice` instead.
 */
export interface InternalGuilderiaGatewayAdapterLibraryMethods {
  destroy(): void;
...
/**
 * @remarks
 * Use `GuilderiaGatewayAdapterImplementerMethods` from `@guilderiajs/voice` instead.
 */
export interface InternalGuilderiaGatewayAdapterImplementerMethods {
  destroy(): void;
...
/**
 * @remarks
 * Use `GuilderiaGatewayAdapterCreator` from `@guilderiajs/voice` instead.
 */
export type InternalGuilderiaGatewayAdapterCreator = (
  methods: InternalGuilderiaGatewayAdapterLibraryMethods,
) => InternalGuilderiaGatewayAdapterImplementerMethods;

// #endregion

// External
export * from '@guilderiajs/rest';
export * from '@guilderiajs/util';
