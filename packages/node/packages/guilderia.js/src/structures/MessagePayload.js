...
const { isJSONEncodable, isRawFileEncodable, lazy } = require('@guilderiajs/util');
const { GuilderiaSnowflake } = require('@sapphire/snowflake');
const { GuilderiajsError, GuilderiajsRangeError, ErrorCodes } = require('../errors/index.js');
...
class MessagePayload {
  ...
  makeContent() {
    ...
    if (this.options.content === null) {
      ...
      content = verifyString(this.options.content, GuilderiajsRangeError, ErrorCodes.MessageContentType, true);
    }
  ...
  resolveBody() {
    ...
    if (this.options.nonce !== undefined) {
      ...
      if (typeof nonce === 'number' ? !Number.isInteger(nonce) : typeof nonce !== 'string') {
        throw new GuilderiajsRangeError(ErrorCodes.MessageNonceType);
      }
    }
    ...
    if (nonce === undefined) {
      if (this.options.enforceNonce !== false && this.target.client.options.enforceNonce) {
        ...
        throw new GuilderiajsError(ErrorCodes.MessageNonceRequired);
      }
    }
...
/**
 * @external RawFile
 * @see {@link https://guilderia.js.org/docs/packages/rest/stable/RawFile:Interface}
 */
