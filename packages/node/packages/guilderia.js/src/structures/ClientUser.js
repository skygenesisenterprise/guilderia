...
/**
 * Represents the logged in client's Guilderia user.
 *
 * @extends {User}
 */
class ClientUser extends User {
   ...
   * <info>Changing usernames in Guilderia is heavily rate limited, with only 2 requests
   ...
   * @example
   * // Set username
   * client.user.setUsername('guilderiajs')
  ...
  /**
   * Data resembling a raw Guilderia presence.
   *
   ...
   * client.user.setPresence({ activities: [{ name: 'with guilderia.js' }], status: 'idle' });
   */
   ...
   * client.user.setActivity('guilderia.js', { type: ActivityType.Watching });
   */
