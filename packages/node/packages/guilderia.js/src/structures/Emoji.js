...
const { formatEmoji } = require('@guilderiajs/formatters');
...
class Emoji extends Base {
  ...
  get createdTimestamp() {
    return this.id && GuilderiaSnowflake.timestampFrom(this.id);
  }
  ...
  /**
   * When concatenated with a string, this automatically returns the text required to form a graphical emoji on Guilderia
