...
/**
 * Represents a Partial Group DM Channel on Guilderia.
 *
 * @extends {BaseChannel}
...
class PartialGroupDMChannel extends BaseChannel {
  ...
  async fetchOwner(options) {
    if (!this.ownerId) {
      throw new GuilderiajsError(ErrorCodes.FetchOwnerId, 'group DM');
    }
  ...
  async delete() {
    throw new GuilderiajsError(ErrorCodes.DeleteGroupDMChannel);
  }

  async fetch() {
    throw new GuilderiajsError(ErrorCodes.FetchGroupDMChannel);
  }
