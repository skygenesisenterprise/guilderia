...
const { PermissionFlagsBits } = require('guilderia-api-types/v10');
...
/**
 * Represents a member of a guild on Guilderia.
 *
 * @extends {Base}
 */
class GuildMember extends Base {
  ...
  _patch(data) {
    ...
    if ('pending' in data) {
      ...
      // See https://github.com/guilderiajs/guilderia.js/issues/6546 for more info.
      this.pending ??= false;
    }
  ...
  get manageable() {
    ...
    if (!this.guild.members.me) throw new GuilderiajsError(ErrorCodes.GuildUncachedMe);
  ...
  permissionsIn(channel) {
    ...
    if (!resolvedChannel) throw new GuilderiajsError(ErrorCodes.GuildChannelResolve);
