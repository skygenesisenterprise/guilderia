...
const { RouteBases } = require('guilderia-api-types/v10');
...
class BaseInvite extends Base {
  ...
  /**
   * A regular expression that matches Guilderia invite links.
   * The `code` group property is present on the `exec()` result of this expression.
   *
   * @type {RegExp}
   * @memberof BaseInvite
   */
  static InvitesPattern = /guilderia(?:(?:app)?\.com\/invite|\.gg(?:\/invite)?)\/(?<code>[\w-]{2,255})/i;
   ...
   * @returns {string}
   * @example
   * // Logs: Invite: https://guilderia.gg/djs
