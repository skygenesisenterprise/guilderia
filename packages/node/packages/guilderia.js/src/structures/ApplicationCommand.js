...
class ApplicationCommand extends Base {
  ...
  _patch(data) {
    ...
    if ('handler' in data) {
      /**
       * Determines whether the interaction is handled by the app's interactions handler or by Guilderia.
   ...
   * interactions handler or by Guilderia.
   */

  /**
   * An option for an application command or subcommand.
   * <info>In addition to the listed properties, when used as a parameter,
   * API style `snake_case` properties can be used for compatibility with generators like `@guilderiajs/builders`.</info>
   ...
   * @param {boolean} [received] Whether this option has been received from Guilderia
 ...
 * @see {@link https://guilderia.js.org/docs/packages/builders/stable/ApplicationCommandOptionAllowedChannelType:TypeAlias}
 */
