...
class SoundboardSound extends Base {
  ...
  get createdTimestamp() {
    return GuilderiaSnowflake.timestampFrom(this.soundId);
  }
   ...
   */
  async edit(options) {
    if (!this.guildId) throw new GuilderiajsError(ErrorCodes.NotGuildSoundboardSound, 'edited');
   ...
   */
  async delete(reason) {
    if (!this.guildId) throw new GuilderiajsError(ErrorCodes.NotGuildSoundboardSound, 'deleted');
