...
const { userMention } = require('@guilderiajs/formatters');
const { calculateUserDefaultAvatarIndex } = require('@guilderiajs/rest');
...
/**
 * Represents a user on Guilderia.
 *
 * @extends {Base}
 */
class User extends Base {
  ...
  _patch(data) {
    ...
    if ('system' in data) {
      /**
       * Whether the user is an Official Guilderia System user (part of the urgent message system)
       *
       * @type {?boolean}
       */
