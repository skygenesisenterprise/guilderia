...
/**
 * Represents a voice-based guild channel on Guilderia.
 *
...
class BaseGuildVoiceChannel extends GuildChannel {
   ...
   * @example
   * // Remove a fixed region for this channel - let Guilderia decide automatically
   * channel.setRTCRegion(null, 'We want to let Guilderia decide.');
   */
