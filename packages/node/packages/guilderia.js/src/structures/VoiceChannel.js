...
const { PermissionFlagsBits, Routes } = require('guilderia-api-types/v10');
const { BaseGuildVoiceChannel } = require('./BaseGuildVoiceChannel.js');

/**
 * Represents a guild voice channel on Guilderia.
 *
 ...
 * voiceChannel.setRTCRegion(null, 'We want to let Guilderia decide.');
 */
