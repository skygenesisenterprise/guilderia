...
const { isFileBodyEncodable, isJSONEncodable } = require('@guilderiajs/util');
...
class MessageManager extends CachedManager {
  ...
  async edit(message, options) {
    ...
    if (!messageId) throw new GuilderiajsTypeError(ErrorCodes.InvalidType, 'message', 'MessageResolvable');
  ...
  async react(message, emoji) {
    ...
    if (!resolvedEmoji) throw new GuilderiajsTypeError(ErrorCodes.EmojiType, 'emoji', 'EmojiIdentifierResolvable');
