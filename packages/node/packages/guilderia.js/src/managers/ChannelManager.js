...
const { lazy, isFileBodyEncodable, isJSONEncodable } = require('@guilderiajs/util');
...
class ChannelManager extends CachedManager {
  ...
  /**
   * Options for fetching a channel from Guilderia
   *
  ...
  /**
   * Obtains a channel from Guilderia, or the channel cache if it's already available.
   *
