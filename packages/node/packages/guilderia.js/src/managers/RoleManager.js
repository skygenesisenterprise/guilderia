...
class RoleManager extends CachedManager {
  ...
  /**
   * Obtains a role from Guilderia, or the role cache if they're already available.
   *
  ...
  async edit(role, options) {
    ...
    if (!resolvedRole) throw new GuilderiajsTypeError(ErrorCodes.InvalidType, 'role', 'RoleResolvable');
  ...
  comparePositions(role1, role2) {
    ...
    if (!resolvedRole1 || !resolvedRole2) {
      throw new GuilderiajsTypeError(ErrorCodes.InvalidType, 'role', 'Role nor a Snowflake');
    }
