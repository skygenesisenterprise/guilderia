...
class GuildSoundboardSoundManager extends CachedManager {
  ...
  async edit(soundboardSound, options = {}) {
    ...
    if (!soundId) throw new GuilderiajsTypeError(ErrorCodes.InvalidType, 'soundboardSound', 'SoundboardSoundResolvable');
  ...
  /**
   * Options used to fetch soundboard sounds from Guilderia
   *
  ...
  /**
   * Obtains one or more soundboard sounds from Guilderia, or the soundboard sound cache if they're already available.
   *
