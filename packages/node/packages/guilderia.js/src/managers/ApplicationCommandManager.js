...
class ApplicationCommandManager extends CachedManager {
  ...
  /**
   * Options used to fetch data from Guilderia
   *
  ...
  /**
   * Options used to fetch Application Commands from Guilderia
   *
  ...
  /**
   * Obtains one or multiple application commands from Guilderia, or the cache if it's already available.
   *
  ...
  async edit(command, data, guildId) {
    ...
    if (!id) throw new GuilderiajsTypeError(ErrorCodes.InvalidType, 'command', 'ApplicationCommandResolvable');
