...
const { GuilderiajsTypeError, ErrorCodes } = require('../errors/index.js');
 ...
 * See {@link https://guilderia.js.org/docs/packages/collection/stable/Collection:Class#sweep Collection#sweep}
...
class Sweepers {
  ...
  sweepEntitlements(filter) {
    if (typeof filter !== 'function') {
      throw new GuilderiajsTypeError(ErrorCodes.InvalidType, 'filter', 'function');
    }
  ...
  static filterByLifetime({
    ...
    if (typeof lifetime !== 'number') {
      throw new GuilderiajsTypeError(ErrorCodes.InvalidType, 'lifetime', 'number');
    }

    if (typeof getComparisonTimestamp !== 'function') {
      throw new GuilderiajsTypeError(ErrorCodes.InvalidType, 'getComparisonTimestamp', 'function');
    }

    if (typeof excludeFromSweep !== 'function') {
      throw new GuilderiajsTypeError(ErrorCodes.InvalidType, 'excludeFromSweep', 'function');
    }
  ...
  _validateProperties(key) {
    ...
    if (typeof props !== 'object') {
      throw new GuilderiajsTypeError(ErrorCodes.InvalidType, `sweepers.${key}`, 'object', true);
    }

    if (typeof props.interval !== 'number') {
      throw new GuilderiajsTypeError(ErrorCodes.InvalidType, `sweepers.${key}.interval`, 'number');
    }

    // Invites, Messages, and Threads can be provided a lifetime parameter, which we use to generate the filter
    if (['invites', 'messages', 'threads'].includes(key) && !('filter' in props)) {
      if (typeof props.lifetime !== 'number') {
        throw new GuilderiajsTypeError(ErrorCodes.InvalidType, `sweepers.${key}.lifetime`, 'number');
      }
    ...
    if (typeof props.filter !== 'function') {
      throw new GuilderiajsTypeError(ErrorCodes.InvalidType, `sweepers.${key}.filter`, 'function');
    }
  }
  ...
  _initInterval(intervalKey, sweepKey, opts) {
    ...
    this.intervals[intervalKey] = setInterval(() => {
      ...
      if (typeof sweepFn !== 'function') throw new GuilderiajsTypeError(ErrorCodes.SweepFilterReturn);
