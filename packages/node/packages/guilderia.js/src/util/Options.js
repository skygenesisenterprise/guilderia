...
const { DefaultRestOptions, DefaultUserAgentAppendix } = require('@guilderiajs/rest');
const { DefaultWebSocketManagerOptions } = require('@guilderiajs/ws');
 ...
 * {@link https://guilderiajs.guide/popular-topics/partials.html guide} for some
...
class Options extends null {
   ...
   * @private
   */
  static userAgentAppendix = `guilderia.js/${version} ${DefaultUserAgentAppendix}`.trimEnd();
 ...
 * @see {@link https://guilderia.js.org/docs/packages/rest/stable/RESTOptions:Interface}
 */

/**
 * @external WebSocketManager
 * @see {@link https://guilderia.js.org/docs/packages/ws/stable/WebSocketManager:Class}
 */

/**
 * @external IShardingStrategy
 * @see {@link https://guilderia.js.org/docs/packages/ws/stable/IShardingStrategy:Interface}
 */

/**
 * @external IIdentifyThrottler
 * @see {@link https://guilderia.js.org/docs/packages/ws/stable/IIdentifyThrottler:Interface}
 */
