...
export async function createGuilderiaBot({ directory, installPackages, typescript, packageManager }: Options) {
	...
	console.log();
	console.log(styleText('green', 'All done! Be sure to read through the guilderia.js guide for help on your journey.'));
