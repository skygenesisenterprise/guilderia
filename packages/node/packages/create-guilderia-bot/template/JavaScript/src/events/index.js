 ...
 *
 * @template {keyof import('guilderia.js').ClientEvents} [EventName=keyof import('guilderia.js').ClientEvents]
 * @typedef {object} Event
 * @property {(...parameters: import('guilderia.js').ClientEvents[EventName]) => Promise<void> | void} execute The function to execute the command
