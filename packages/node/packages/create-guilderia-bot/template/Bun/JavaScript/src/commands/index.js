 ...
 * @property {import('guilderia.js').RESTPostAPIApplicationCommandsJSONBody} data The data for the command
 * @property {(interaction: import('guilderia.js').CommandInteraction) => Promise<void> | void} execute The function to execute when the command is called
 */
