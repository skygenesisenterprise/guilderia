...
import { GuilderiaMessageAuthorReply, type IGuilderiaMessageAuthorReply } from './MessageAuthorReply.js';

export function GuilderiaMessageBaseReply({
	author,
	authorNode,
	children,
}: PropsWithChildren<{
	...
	return (
		...
		>
			<div className="flex place-items-center [&>span]:opacity-60">
				{author ? <GuilderiaMessageAuthorReply {...author} /> : authorNode}
			</div>
			{children}
		</div>
	);
