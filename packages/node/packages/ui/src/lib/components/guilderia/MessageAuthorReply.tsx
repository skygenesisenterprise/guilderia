...
export interface IGuilderiaMessageAuthorReply {
...
export function GuilderiaMessageAuthorReply({ avatar, bot, verified, color, username }: IGuilderiaMessageAuthorReply) {
	return (
		<>
